...
Firstly we will start playbook running command `ansible-playbook playbooks/dev/main.yml --diff`:
...
ok: [localhost]
TASK [docker : include_tasks] **************************************************************************************************************************************************************
included: /home/maruf/study/devops/core-course-labs/ansible/roles/docker/tasks/install_compose.yml for localhost
...
Then we run the command `ansible-inventory -i inventory/default.yml --list`:
...
We will start playbook running command `ansible-playbook playbooks/dev/web_app.yml --diff` and check last 50 lines:
...
Then app could be reached at `localhost`
