...
## For additional app:
```
edikgoose@edikgoose-NBLB-WAX9N:~/iu-devops/ansible$ ansible-playbook playbooks/dev/app_kotlin/main.yml

PLAY [Deploy dockerized kotlin app] ******************************************************************************************
...
TASK [web_app : Remove base-converter directory] *****************************************************************************
changed: [edikgoose-compute-instance]
...
TASK [web_app : Create base-converter directory] *****************************************************************************
changed: [edikgoose-compute-instance]

TASK [web_app : Deliver docker compose file to /home/ubuntu/base-converter] **************************************************
changed: [edikgoose-compute-instance]
...
PLAY RECAP *******************************************************************************************************************
edikgoose-compute-instance : ok=22   changed=7    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0   
```


Inside VM:
```
ubuntu@fhm5rc5fikgqqvkn2gq9:~$ sudo docker ps -a
CONTAINER ID   IMAGE                              COMMAND                  CREATED          STATUS          PORTS                                       NAMES
d58df33a0453   edikgoose/moscow-time-app:latest   "uvicorn src.main:ap…"   42 seconds ago   Up 29 seconds   0.0.0.0:80->80/tcp, :::80->80/tcp           moscow-time-app
0c1a856a960f   edikgoose/base-converter:latest    "java -jar /app/base…"   3 minutes ago    Up 3 minutes    0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   base-converter
```