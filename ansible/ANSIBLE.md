...
Lab6
```
muurrk@muurrk-PS42-8M:~/core-course-labs/ansible$ ansible-playbook --private-key ~/.ssh/DevOpsLab.pem playbooks/dev/web_app_cpp.yml 
...
**********************************************************************************
*****************************
ok: [ubuntu@185.130.114.25]


TASK [docker : Do apt update] 
**********************************************************************************
**********************
changed: [ubuntu@185.130.114.25]
...
TASK [web_app : Download docker-compose.yml] 
**********************************************************************************
*******
ok: [ubuntu@185.130.114.25]
