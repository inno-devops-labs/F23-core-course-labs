...
included: mbp-pbakharuev-OZON-FVFG74Q1Q05N/учеба/devops-course-labs/ansible/roles/docker/tasks/install_pip.yml for vm01
...
TASK [docker : include_tasks] ***************************************************************
included: mbp-pbakharuev-OZON-FVFG74Q1Q05N/учеба/devops-course-labs/ansible/roles/docker/tasks/install_docker.yml for vm01

TASK [docker : Install docker] **************************************************************
changed: [vm01]

TASK [docker : include_tasks] ***************************************************************
included: mbp-pbakharuev-OZON-FVFG74Q1Q05N/учеба/devops-course-labs/ansible/roles/docker/tasks/install_compose.yml for vm01
...
--- before
+++ after: /home/pavel5609/.ansible/tmp/ansible-local-859na3m65bb/tmpmyg4k3gu/docker-compose.yml.j2
@@ -0,0 +1,9 @@
+version: '3.9'
+
+services:
+  web_app_python:
+    image: pavel5609/do_course
+    container_name: do_course
+    ports:
+      - 5000:8000
+    restart: always
