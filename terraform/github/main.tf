...
resource "github_repository" "iu-devops-course-2" {
  name             = "iu-devops-course-2"
...
resource "github_branch_default" "main" {
  repository = github_repository.iu-devops-course-2.name
  branch     = "main"
}

# Create branch protection rule to protect the default branch
resource "github_branch_protection" "default" {
  repository_id                   = github_repository.iu-devops-course-2.id
