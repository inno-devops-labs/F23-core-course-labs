## Best practices for Terraform
 ...
 k-tyulebaeva-osx:terraform  k-tyulebaeva$ terraform init
...
k-tyulebaeva-osx:terraform  k-tyulebaeva$  terraform apply
 ...
 k-tyulebaeva-osx:terraform k-tyulebaeva$     terraform state show
 ...
 k-tyulebaeva-osx:terraform k-tyulebaeva$     terraform state show docker_container.nginx
 ...
 k-tyulebaeva-osx:terraform k-tyulebaeva$     terraform state listx
 ...
 k-tyulebaeva-osx:terraform k-tyulebaeva$     terraform state list
 docker_container.nginx
 docker_image.nginx
 ```
 # Changing container name
 ```sh
 k-tyulebaeva-osx:docker k-tyulebaeva$ terraform apply -var "container_name=YetAnotherName"
 ...
 ```
 ```sh
 k-tyulebaeva-osx:docker k-tyulebaeva$ terraform output
 ...
 ## Yandex cloud
 ```sh
 k-tyulebaeva-osx:cloud k-tyulebaeva$ terraform apply
 Terraform used the selected providers to generate the following execution plan. Resource actions are indicated with the following symbols:
   + create
 Terraform will perform the following actions:
 ...
 k-tyulebaeva-osx:cloud k-tyulebaeva$ terraform state list
 yandex_compute_instance.vm-1
 yandex_compute_instance.vm-2
 yandex_vpc_network.network-1
 yandex_vpc_subnet.subnet-1
 k-tyulebaeva-osx:cloud k-tyulebaeva$ terraform state show yandex_compute_instance.vm-1
 # yandex_compute_instance.vm-1:
 resource "yandex_compute_instance" "vm-1" {
 ...
 k-tyulebaeva-osx:cloud k-tyulebaeva$ terraform output
 external_ip_address_vm_1 = "51.250.92.190"
 external_ip_address_vm_2 = "51.250.6.202"
 internal_ip_address_vm_1 = "192.168.10.31"
 internal_ip_address_vm_2 = "192.168.10.25"
 ...
 ```sh
 k-tyulebaeva-osx:github k-tyulebaeva$ terraform apply  -var "token=$PAT_TOKEN"
 github_repository.repo: Refreshing state... [id=k-tyulebaeva-Demo-Repo]
 Terraform used the selected providers to generate the following execution plan. Resource actions are indicated with the following symbols:
   + create
 Terraform will perform the following actions:
   ...
   + resource "github_branch_default" "main" {
       + branch     = "main"
       + id         = (known after apply)
       + repository = "k-tyulebaeva-Demo-Repo"
     }
   ...
   + resource "github_branch_protection" "default" {
       ...
       + id                              = (known after apply)
       + pattern                         = "main"
       + repository_id                   = "k-tyulebaeva-Demo-Repo"
 ...
 github_branch_default.main: Creation complete after 3s [id=k-tyulebaeva-Demo-Repo]
 github_branch_protection.default: Creating...
 github_branch_protection.default: Creation complete after 6s [id=BPR_kwDOKYwptc4CgXbH]
 Apply complete! Resources: 2 added, 0 changed, 0 destroyed.
 ```
 - Created repo https://github.com/KarinaTyulebaeva/k-tyulebaeva-Demo-Repo