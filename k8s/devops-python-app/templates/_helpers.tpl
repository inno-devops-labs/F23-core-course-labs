...
*/}}
{{- define "devops-python-app.chart" -}}
...
app.kubernetes.io/name: {{ include "devops-python-app.name" . }}
...
{{- default (include "devops-python-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
