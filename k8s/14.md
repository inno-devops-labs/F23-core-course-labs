...
`kubectl get cm` shows a big number of config maps for Kube Prometheus Stack
...
I could not access grafana dashboard with minikube, so I used kubectl port-forward
