...
Containers:
  app-python:
    ...
    Image:          docker.io/beleet/devops-app-python:latest
    Image ID:       docker-pullable://beleet/devops-app-python@sha256:e385636460645fb144fed865c023c39e55065e04917f4b798c35522633e61d77
    Port:           80/TCP
    Host Port:      0/TCP
    State:          Running
...
Events:
  ...
  Normal  Pulled     6m32s  kubelet            Container image "docker.io/beleet/devops-app-python:latest" already present on machine
...
Containers:
  app-go:
    ...
    Image:          docker.io/beleet/devops-app-go:latest
    Image ID:       docker-pullable://beleet/devops-app-go@sha256:253dcf744d0fe968fb46c849a853ab7a5e7dd76438466cb0d8d6c44ad74ba5d9
    Port:           80/TCP
    Host Port:      0/TCP
    State:          Running
...
Events:
  ...
  Normal  Pulled     29s   kubelet            Container image "docker.io/beleet/devops-app-go:latest" already present on machine
