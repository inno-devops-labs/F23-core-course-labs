...
```
>$ kubectl exec python-app-6dbc9fd4d8-hqpdf -- printenv | grep MY_PASSWORD
...
python-app-6dbc9fd4d8-hqpdf            1/1     Running   0          88m
...
```
>$ kubectl exec -it python-app-6dbc9fd4d8-hqpdf -- /bin/sh
...
```
>$ kubectl exec python-app-6dbc9fd4d8-hqpdf -- printenv | grep -e 'RELEASE_NAME' -e 'MY_PASS' -e 'SLEEP_TIME'
