...
```sh
myuser@app-python-5f6fd9c499-b4ddk:/app$ cat /vault/secrets/database-config.txt
data: map[password:db-secret-password username:db-readonly-username]
metadata: map[created_time:2023-11-14T18:42:12.223220345Z custom_metadata:<nil> deletion_time: destroyed:false version:1]
```

```sh
myuser@app-python-5f6fd9c499-b4ddk:/app$ df -h
Filesystem      Size  Used Avail Use% Mounted on
overlay         251G   29G  210G  13% /
tmpfs            64M     0   64M   0% /dev
tmpfs           7.7G  4.0K  7.7G   1% /vault/secrets
tmpfs           3.9G     0  3.9G   0% /sys/fs/cgroup
/dev/sdd        251G   29G  210G  13% /etc/hosts
